    ...
    public partial class Form1 : Form
    {
            ...
            try
            {
                ...
                if (groupBox1.Text == "Inserir Maquinista")
                {
                    ...
                    consulta("Insert into viras (codigo_local_vira, codigo_linha, hora_entrada, maquinista, sequencia, obs, Tv) values "
                        + "(" + codigo_local_vira + ", " + linha + ", '" + maquinista.hora_entrada_vira + "', '" + maquinista.matricula + "', " + odtAux.Rows[0]["sequencia"].ToString() + " + 1, '" + txt_obs.Text + "', '" + Tv + "')", "viras");

                    if (status_consulta == true)
                    {
                        consulta("Insert into maquinistas_registros (matricula_maquinista, data_hora_entrada, destacado) values ('" + maquinista.matricula + "', '" + maquinista.data_hora_entrada + ":00', '" + destacado + "')", "maquinistas_registros");
                ...
                if (groupBox1.Text == "Remover Maquinista")
                {
                    ...
                    if (checkBox1.Checked == true)
                        destacado = "SIM";
                    consulta("update maquinistas_registros set data_hora_saida = '" + maquinista.data_hora_entrada + "', destacado = '" + destacado + "' where matricula_maquinista = '" + maquinista.matricula + "' and data_hora_saida is null", "maquinistas_registros");
                    if (status_consulta == true)
                        consulta("update viras set hora_saida = '" + maquinista.hora_entrada_vira + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
                ...
                if (groupBox1.Text == "Editar Maquinista")
                {
                    ...
                    consulta("update maquinistas_registros set data_hora_entrada = '" + maquinista.data_hora_entrada + "', destacado = '" + destacado + "' where matricula_maquinista = '" + maquinista.matricula + "' and data_hora_saida is null", "maquinistas_registros");

                    if (status_consulta == true)
                        consulta("update viras set hora_entrada = '" + maquinista.hora_entrada_vira + "', obs = '" + txt_obs.Text + "', Tv = '" + Tv + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
        ...
        void texto3_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (info_sendo_movido.trem == "")
                consulta("update viras set Hora_saida = '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss").ToString() + "', próxima_escala = '" + info.prefixo + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
            else
        ...
        void Local_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (info.trem == "")
                consulta("update viras set hora_saida = '" + maquinista.hora_entrada_vira + "', próxima_escala = '" + local.Controls[0].Name + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
            else
            ...
            if (status_consulta == true)
            {
                ...
                if (status_consulta == true)
                    consulta("Insert into viras (codigo_local_vira, codigo_linha, hora_entrada, maquinista, sequencia) values "
                              + "(" + local.Name + ", " + linha + ", '" + maquinista.hora_entrada_vira + "', '" + maquinista.matricula + "', " + odtAux.Rows[0]["sequencia"].ToString() + " + 1)", "viras");
                if (status_consulta == true)
                    odtAux = consulta("update Linha set atualizacao = (atualizacao + 1) where codigo = " + linha, "linha");
                atualizacao = atualizacao + 1;
            }
