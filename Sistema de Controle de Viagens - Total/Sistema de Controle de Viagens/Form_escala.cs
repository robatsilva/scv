...
namespace Sistema_de_Controle_de_Viagens
{
    public partial class Form_escala : Form
    {
       ...
       private void carrega_vira(int sequencia_vira, int height)
        {
            odtAux = banco_dados.consulta(timer1, "select codigo, local_vira, sequencia_local_vira from locais_vira where codigo_linha = " + linha + " and (Sequencia_local_vira mod 2) = " + sequencia_vira + " and tela = 'VIRA'", "Locais_vira");
            if (sequencia_vira == 0)
                left = 10;
            else
            ...
            for (int i = 0; i < odtAux.Rows.Count; i++)
            {
                ...
                odt_aux2 = banco_dados.consulta(timer1, sql, "Viras");
                ...
                {
                    odt_aux3 = banco_dados.consulta(timer1, "select max(prefixo) as prefixo from andamento where linha = " + linha + " and prefixo < 700 and sequencia mod 2 = 1", "andamento");
                    try
                ...
                {
                    odt_aux3 = banco_dados.consulta(timer1, "select max(prefixo) as prefixo from andamento where linha = " + linha + " and prefixo < 700 and sequencia mod 2 = 0", "andamento");
                    try
                    { prefixo_sujerido_externo = odt_aux3.Rows[0]["prefixo"].ToString(); }
                    catch
                    { prefixo_sujerido_externo = null; }
                ...
                for (int n = 0; n < odt_aux2.Rows.Count; n++)
                {
                    ...
                    try
                    {
                        if (local.Name.ToString() == cmbVira.SelectedValue.ToString())
                        {
                            panel5.Controls.Add(cria_label_maquinista(odt_aux2, n, trem_vira));
                            panel5.Controls[panel5.Controls.Count - 1].Font = new Font("Arial Black", 30);
                            panel5.Controls[panel5.Controls.Count - 1].Width = panel5.Width;
                            panel5.Controls[panel5.Controls.Count - 1].Height = 70;
                            panel5.Controls[panel5.Controls.Count - 1].Top = n * 70 + 30;
                        }   
                    }
                    catch { }
                }
        ...
        {
            odtAux = banco_dados.consulta(timer1, "select codigo, local_vira from locais_vira where codigo_linha = " + linha + " and tela = 'LOCAIS'", "Locais_vira");
            left = 10;
            DataTable odt_aux2;
        ...
        {
            odtAux = banco_dados.consulta(timer1, "select codigo, local_vira from locais_vira where tela = 'NÃO DEFINIDO'", "Locais_vira");
            ...
            for (int i = 0; i < odtAux.Rows.Count; i++)
            {
                ...
                for (int n = 0; n < odt_aux2.Rows.Count; n++)
                {
                    ...
                    DataTable odt_aux3;
                    odt_aux3 = banco_dados.consulta(timer1, sub_sql, "historico");
                    string pe;
                    try
                    {
        ...
        private void atualiza()
        {
            ...
            catch (Exception e)
            {
                ...
                banco_dados.consulta(timer1, "Insert Into Logs (Log, data) Values ('Err escala Atualização - " + e.Message + "', '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')", "Log");
                timer1.Enabled = true;
            }
        ...
        private void Form1_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                panel5.Width = tabControl1.Width - 10;
                panel5.Height = tabControl1.Height - 10;
            ...
            catch (Exception ex)
            {
                ...
                banco_dados.consulta(timer1, "Insert Into Logs (Log, data) Values ('Err escala Load - " + ex.Message + "', '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')", "Log");
                timer1.Enabled = true;
        ...
        private void btnGravar_Click(object sender, EventArgs e)
        {
            ...
            if (banco_dados.status_consulta == false)
                return;
            try
            {
                ...
                if (groupBox1.Text == "Criar Local")
                {
                    ...
                    {
                        banco_dados.consulta(timer1, "insert into locais_vira (codigo_linha, local_vira, Tela) values (" + linha + ", '" + txt_obs.Text.ToUpper() + "', 'LOCAIS')", "locais_vira");
                        atualiza();
                    }
                }
                if (groupBox1.Text == "Editar Local")
                {
                    ...
                    {
                        banco_dados.consulta(timer1, "update locais_vira set local_vira = '" + txt_obs.Text.ToUpper() + "' where codigo = " + codigo_local_vira, "locais_vira");
                        atualiza();
                    }
                }
                if (groupBox1.Text == "Cadastrar Maquinista")
                {
                    ...
                    odtAux = banco_dados.consulta(timer1, "select * from maquinistas where matricula = '" + txt_data_hora_entrada.Text + "'", "maquinistas");
                    ...
                    banco_dados.consulta(timer1, "insert into maquinistas (matricula, nome) values ('" + txt_data_hora_entrada.Text + "', '" + cmb_maquinista.Text.ToUpper() + "')", "maquinistas");
                ...
                if (groupBox1.Text == "Inserir Maquinista")
                {
                    ...
                    odtAux = banco_dados.consulta(timer1, "select * from maquinistas_registros where matricula_maquinista = '" + maquinista.matricula + "' and data_hora_saida is null", "maquinistas_registros");
                    if (odtAux.Rows.Count > 0)
                    {
                    ...
                    banco_dados.consulta(timer1, "Insert into viras (codigo_local_vira, codigo_linha, hora_entrada, maquinista, sequencia, obs, Tv) values "
                    ...
                    {
                        banco_dados.consulta(timer1, "Insert into maquinistas_registros (matricula_maquinista, data_hora_entrada, destacado) values ('" + maquinista.matricula + "', '" + Convert.ToDateTime(maquinista.data_hora_entrada).ToString("yyyy-MM-dd HH:mm:ss") + ":00', '" + destacado + "')", "maquinistas_registros");

                        if (banco_dados.status_consulta == true)
                            banco_dados.consulta(timer1, "update Linha set atualizacao = (atualizacao + 1) where codigo = " + linha, "linha");
                    }
                ...
                if (groupBox1.Text == "Remover Maquinista")
                {
                    ...
                    if (checkBox1.Checked == true)
                        destacado = "SIM";
                    banco_dados.consulta(timer1, "update maquinistas_registros set data_hora_saida = '" + Convert.ToDateTime(maquinista.data_hora_entrada).ToString("yyyy-MM-dd HH:mm:ss") + "', destacado = '" + destacado + "' where matricula_maquinista = '" + maquinista.matricula + "' and data_hora_saida is null", "maquinistas_registros");
                    if (banco_dados.status_consulta == true)
                        banco_dados.consulta(timer1, "update viras set hora_saida = '" + Convert.ToDateTime(maquinista.hora_entrada_vira).ToString("yyyy-MM-dd HH:mm:ss") + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
                ...
                if (groupBox1.Text == "Editar Maquinista")
                {
                    ...
                    banco_dados.consulta(timer1, "update maquinistas_registros set data_hora_entrada = '" + Convert.ToDateTime(maquinista.data_hora_entrada).ToString("yyyy-MM-dd HH:mm:ss") + "', destacado = '" + destacado + "' where matricula_maquinista = '" + maquinista.matricula + "' and data_hora_saida is null", "maquinistas_registros");

                    if (banco_dados.status_consulta == true)
                        banco_dados.consulta(timer1, "update viras set hora_entrada = '" + Convert.ToDateTime(maquinista.hora_entrada_vira).ToString("yyyy-MM-dd HH:mm:ss") + "', obs = '" + txt_obs.Text + "', Tv = '" + Tv + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
            ...
            catch (Exception ex)
            {
                ...
                banco_dados.consulta(timer1, "Insert Into Logs (Log, data) Values ('Err escala - Gravar" + ex.Message + "', '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')", "Log");
                timer1.Enabled = true;
            }
        }
        ...
        private void prefixo_MouseDoubleClick(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                banco_dados.consulta(timer1, "Insert Into Logs (Log, data) Values ('Err escala editar - " + ex.Message + "', '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')", "Log");
                timer1.Enabled = true;
            }
        }
        ...
        void texto3_DragEnter(object sender, DragEventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                banco_dados.consulta(timer1, "Insert Into Logs (Log, data) Values ('Err escala drag enter - " + ex.Message + "', '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')", "Log");
                timer1.Enabled = true;
            }
        }
        ...
        void texto3_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (info_sendo_movido.trem == "")
                banco_dados.consulta(timer1, "update viras set Hora_saida = '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss").ToString() + "', proxima_escala = '" + info.prefixo + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
            else
                banco_dados.consulta(timer1, "update andamento set Maquinista = '' where id = '" + matricula.trem + "'", "viras");

            if (banco_dados.status_consulta == true)
                banco_dados.consulta(timer1, "update andamento set maquinista = '" + maquinista.matricula + "' where id = '" + info.trem + "' ", "andamento");
            odtAux = banco_dados.consulta(timer1, "update Linha set atualizacao = (atualizacao + 1) where codigo = " + linha, "linha");
            atualizacao = atualizacao + 1;
            atualiza();
        }
        ...
        void texto_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (sendo_movido.Parent == mqt.Parent && sendo_movido != sender)
            {
                ...
                banco_dados.consulta(timer1, "update viras set sequencia = sequencia + 1 where sequencia >= " + info.sequencia + " and codigo_local_vira = " + mqt.Parent.Name + " and hora_saida is null", "viras");
                if (banco_dados.status_consulta == true)
                    banco_dados.consulta(timer1, "update viras set sequencia = " + info.sequencia + " where maquinista = '" + info_sendo_movido.maquinista + "' and hora_saida is null", "viras");
                odtAux = banco_dados.consulta(timer1, "update Linha set atualizacao = (atualizacao + 1) where codigo = " + linha, "linha");
                atualizacao = atualizacao + 1;
                atualiza();
            }
        ...
        void Local_DragDrop(object sender, DragEventArgs e)
        {
            ...
            if (info.trem == "")
                banco_dados.consulta(timer1, "update viras set hora_saida = '" + Convert.ToDateTime(maquinista.hora_entrada_vira).ToString("yyyy-MM-dd HH:mm:ss") + "', proxima_escala = '" + local.Controls[0].Name + "' where maquinista = '" + maquinista.matricula + "' and hora_saida is null", "viras");
            else
                banco_dados.consulta(timer1, "update andamento set maquinista = '' where id = '" + info.trem + "' ", "andamento");
            if (banco_dados.status_consulta == true)
            {
                odtAux = banco_dados.consulta(timer1, "select Max(sequencia) as sequencia from viras where codigo_local_vira = " + local.Name + " and hora_saida is null", "viras");
                if (banco_dados.status_consulta == true)
        ...
        private void cmbLinha_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            cmbVira.DisplayMember = "local_vira";
            cmbVira.ValueMember = "codigo";
            cmbVira.DataSource = banco_dados.consulta(timer1, "Select * From locais_vira where local_vira != 'NÃO DEFINIDO' and tela = 'vira' and codigo_linha = " + cmbLinha.SelectedValue.ToString(), "locais_vira");
        }
        ...
        private void timer1_Tick(object sender, EventArgs e)
        {
            ...
            catch (Exception ex)
            {
                ...
                banco_dados.consulta(timer1, "Insert Into Logs (Log, data) Values ('Err escala timer - " + ex.Message + "', '" + DateTime.Now.ToString("yyyy-MM-dd HH:mm:ss") + "')", "Log");
                timer1.Enabled = true;
                banco_dados.status_consulta = true;
            }
        }
        ...
        private void editarToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            maquinista.matricula = info.maquinista;
            odtAux = banco_dados.consulta(timer1, "Select * from maquinistas_registros where matricula_maquinista = '" + info.maquinista + "' and data_hora_saida is null", "maquinistas_registros");
        ...
        private void excluirLocalToolStripMenuItem_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    banco_dados.consulta(timer1, "Delete from locais_vira where codigo = " + codigo_local_vira, "Locais_vira");
                    atualiza();
                }
            }
        }
        ...
        private void btn_editar_mqt_Click(object sender, EventArgs e)
        {
            ...
            {
                banco_dados.consulta(timer1, "update maquinistas set nome = '" + txt_nome_editar.Text.ToUpper() + "' where matricula = '" + txt_matricula_editar.Text + "'", "maquinistas");
        ...
        {
            banco_dados.consulta(timer1, "update maquinistas set status = 'Inativo' where matricula = '" + txt_matricula_editar.Text + "'", "maquinistas");
        ...
        {
            DataTable odt_aux = banco_dados.consulta(timer1, "select * from (select prefixo as Prefixo, trem as Trem, nome as Nome, if(final_viagem = 'Excluído', final_viagem, null) as final_viagem "
        ...
        private void cmbVira_SelectedIndexChanged(object sender, EventArgs e)
        {            
            atualiza();            
        }
